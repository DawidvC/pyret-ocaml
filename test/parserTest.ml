...
let test_empty = Utils.test_parses "empty" ""
...
let test_lets_letrecs =
  let should_fail = Utils.test_parse_fails "let"
  and should_pass = Utils.test_parses "let" in
...
let test_type_lets =
  let should_fail = Utils.test_parse_fails "type-let"
  and should_pass = Utils.test_parses "type-let" in
...
let test_standalone_types =
  let should_fail = Utils.test_parse_fails "standalone"
  and should_pass = Utils.test_parses "standalone" in
...
let test_standalone_newtypes =
  let should_fail = Utils.test_parse_fails "standalone-new"
  and should_pass = Utils.test_parses "standalone-new" in
...
let test_provide_types =
  let should_pass = Utils.test_parses "provide-types" in
...
let test_provide_types_exprs =
  let should_fail = Utils.test_parse_fails "provide-types-exprs" in
...
let test_english_op_ident =
  let should_fail = Utils.test_parse_fails "english-op-ident" in
  let wss = [" ";" \n"; "\n "; " \n"; " \n "]
...
let test_hyphen_ident =
  let should_fail = Utils.test_parse_fails "hyphen-ident"
  and should_pass = Utils.test_parses "hyphen-ident" in
...
let test_english_ops =
  let should_fail = Utils.test_parse_fails "english-ops"
  and should_pass = Utils.test_parses "english-ops" in
  let wss = [" ";" \n";"\n ";" \n";" \n "]
  and en_ops = ["or";"and";"is";"satisfies";"raises"] in
  let do_test ctx =
    let test_with_ws op ws =
...
let test_parse_errors =
  let should_fail = Utils.test_parse_fails "parse-errors" in
...
let test_angle_brackets_type_inst =
  let should_fail = Utils.test_parse_fails "angle-brackets-type-inst"
  and should_pass = Utils.test_parses "angle-brackets-type-inst" in
...
let test_angle_brackets_func =
  let should_fail = Utils.test_parse_fails "angle-brackets-func"
  and should_pass = Utils.test_parses "angle-brackets-func" in
...
let test_angle_gt_lt =
  let should_fail = Utils.test_parse_fails "angle-gt-lt"
  and should_pass = Utils.test_parses "angle-gt-lt" in
...
let test_angle_whitespace =
  let should_pass = Utils.test_parses "angle-whitespace" in
...
let test_paren_op =
  let should_pass = Utils.test_parses "paren-op" in
...
let test_semi_eof =
  let should_pass = Utils.test_parses "semi-eof" in
  "should not mind ; at EOF">:::[
    should_pass "lam<T>(x :: T) -> T: x;"
  ]

let test_semi_eol =
  let should_pass = Utils.test_parses "semi-eol" in
...
let test_ws_coloncolon_thickarrow =
  let should_fail = Utils.test_parse_fails "ws-coloncolon-thickarrow"
  and should_pass = Utils.test_parses "ws-coloncolon-thickarrow" in
...
let test_paren_group_comma =
  let should_pass = Utils.test_parses "paren-grp-comma" in
...
let test_paren_group_colon =
  let should_pass = Utils.test_parses "paren-grp-colon" in
  "should treat (...) as grouping after :">:::[
...
let test_paren_group_eq =
  let should_pass = Utils.test_parses "paren-grp-eq" in
  "should treat (...) as grouping after =">:::[
...
let test_paren_group_coloneq =
  let should_pass = Utils.test_parses "paren-grp-coloneq" in
  "should treat (...) as grouping after :=">:::[
    should_pass "block: x:=(x) end";
    should_pass "block: x := (x) end";
    should_pass "block: x :=\n(x) end";
...
let test_paren_group_semi =
  let should_pass = Utils.test_parses "paren-grp-semi" in
  "should treat (...) as grouping after ;">:::[
...
let test_get_bang =
  let should_pass = Utils.test_parses "get-bang" in
...
let test_update =
  let should_pass = Utils.test_parses "update" in
  "should parse update">:::[
    should_pass "o!{x:5}";
...
let test_ref_data_defs =
  let should_pass = Utils.test_parses "ref-data-defs" in
...
let test_ref_obj_lits =
  let should_fail = Utils.test_parse_fails "ref-obj-lits"
  and should_pass = Utils.test_parses "ref-obj-lits" in
...
let test_imports =
  let should_fail = Utils.test_parse_fails "imports"
  and should_pass = Utils.test_parses "imports" in
...
let test_includes =
  let should_fail = Utils.test_parse_fails "includes"
  and should_pass = Utils.test_parses "includes" in
...
let test_new_eqops =
  let should_fail = Utils.test_parse_fails "new-eqops"
  and should_pass = Utils.test_parses "new-eqops" in
...
let test_examples =
  let should_pass = Utils.test_parses "examples" in
  "should parse examples">:::[
    should_pass "examples: 5 is 5 end";
  ]

let test_ref_cases =
  let should_fail = Utils.test_parse_fails "ref-cases"
  and should_pass = Utils.test_parses "ref-cases" in
...
let test_type_params_methods =
  let should_pass = Utils.test_parses "type-params-methods" in
...
let test_rec_stmts =
  let should_fail = Utils.test_parse_fails "rec-stmts"
  and should_pass = Utils.test_parses "rec-stmts" in
...
let test_brack_exprs =
  let should_fail = Utils.test_parse_fails "brack-exprs" in
  "shouldn't parse bracket exprs">:::[
    should_fail "o.[x]";
  ]

let test_str_keys =
  let should_fail = Utils.test_parse_fails "str-keys" in
...
let test_block_comments =
  let should_fail = Utils.test_parse_fails "block-comments"
  and should_pass = Utils.test_parses "block-comments" in
